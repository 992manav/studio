...
stockShelf({ name: 'Wrangler Mens Jeans', price: 19.98, description: 'Regular fit straight leg jeans for men.', image: 'https://i5.walmartimages.com/seo/Wrangler-Men-s-Regular-Fit-Jeans-Medium-Wash-34x32_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e-4d2e4f9e3b3d.jpeg', category: 'Apparel', size: [0.8, 0.1, 1], hint: 'folded jeans' }, [aisle4XLeft, shelfY.high, aisleZStart], 50, 'z');
stockShelf({ name: 'Secret Deodorant', price: 5.47, description: 'Invisible solid antiperspirant and deodorant.', image: 'https://i5.walmartimages.com/seo/Secret-Outlast-XTend-Invisible-Solid-Antiperspirant-Deodorant-Completely-Clean-2-6-oz_a2b3b7c8-2b8a-4b7e-9b0a-7b3b7c8a2b3b.7b3b7c8a2b3b7c8a2b3b7c8a2b3b.jpeg', category: 'Personal Care', size: [0.4, 0.6, 0.2], hint: 'deodorant stick' }, [aisle4XRight, shelfY.high, aisleZStart], 70, 'z');
stockShelf({ name: 'Hanes Mens Socks', price: 10.98, description: '12-pack of white crew socks.', image: 'https://i5.walmartimages.com/seo/Hanes-Men-s-Crew-Socks-12-Pack_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e-4d2e4f9e3b3d.jpeg', category: 'Apparel', size: [0.8, 0.2, 0.6], hint: 'packaged socks' }, [aisle4XLeft, shelfY.bottom, aisleZStart], 70, 'z');

// --- Back Aisle: Electronics, Toys, Sporting Goods (z = -50) ---
const backAisleZBack = -50.8;
const backAisleZFront = -49.2;
stockShelf({ name: 'onn. 50" TV', price: 198.0, description: '50" Class 4K UHD LED Roku Smart TV.', image: 'https://i5.walmartimages.com/seo/onn-50-Class-4K-UHD-LED-Roku-Smart-TV-HDR-100012585_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e-4d2e4f9e3b3d.jpeg', category: 'Electronics', size: [4.5, 2.5, 0.2], hint: 'television box' }, [aisleXStart, shelfY.mid, backAisleZBack], 16, 'x');
stockShelf({ name: 'PlayStation 5', price: 499.99, description: 'The Sony PlayStation 5 console.', image: 'https://m.media-amazon.com/images/I/619BkvKW35L._AC_SL1500_.jpg', category: 'Electronics', size: [1.2, 1.4, 0.6], hint: 'console box' }, [aisleXStart, shelfY.high, backAisleZBack], 20, 'x');
stockShelf({ name: 'Apple AirPods', price: 129.00, description: '2nd Gen Apple AirPods w/ Charging Case.', image: 'https://store.storeimages.cdn-apple.com/4668/as-images.apple.com/is/MV7N2?wid=2000&hei=2000&fmt=jpeg&qlt=95&.v=1551489688005', category: 'Electronics', size: [0.3, 0.4, 0.3], hint: 'airpods box' }, [aisleXStart + 15, shelfY.low, backAisleZBack], 50, 'x');
stockShelf({ name: 'onn. Bluetooth Speaker', price: 20.00, description: 'Portable bluetooth speaker.', image: 'https://i5.walmartimages.com/seo/onn-Portable-Bluetooth-Speaker-Black-100008734_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e-4d2e4f9e3b3d.jpeg', category: 'Electronics', size: [0.8, 0.5, 0.4], hint: 'speaker box' }, [aisleXStart + 22, shelfY.low, backAisleZBack], 50, 'x');
stockShelf({ name: 'LEGO Classic Bricks', price: 20.00, description: 'A box of 484 classic LEGO bricks.', image: 'https://target.scene7.com/is/image/Target/GUEST_4c7e3c7f-9e3b-4f8d-9e4d-2e4f9e3b3d4f?wid=488&hei=488&fmt=pjpeg', category: 'Toys', size: [1.2, 0.8, 0.5], hint: 'lego box' }, [aisleXStart, shelfY.low, backAisleZFront], 36, 'x');
stockShelf({ name: 'Barbie Dreamhouse', price: 179.00, description: 'The ultimate dollhouse with 3 stories.', image: 'https://i5.walmartimages.com/seo/Barbie-Dreamhouse-Dollhouse-with-75-Accessories_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e-4d2e4f9e3b3d.jpeg', category: 'Toys', size: [2.5, 2.5, 1], hint: 'dollhouse box' }, [aisleXStart + 25, shelfY.top, backAisleZFront], 10, 'x');
stockShelf({ name: 'Nerf Elite 2.0 Blaster', price: 14.97, description: 'Includes 16 Nerf Elite darts.', image: 'https://i5.walmartimages.com/seo/Nerf-Elite-2-0-Commander-RD-6-Blaster-16-Darts_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e-4d2e4f9e3b3d.jpeg', category: 'Toys', size: [1.5, 0.8, 0.4], hint: 'toy gun box' }, [aisleXStart, shelfY.mid, backAisleZFront], 30, 'x');
stockShelf({ name: 'Spalding Basketball', price: 15.88, description: 'Official size street basketball.', image: 'https://m.media-amazon.com/images/I/91A90PxvHHL.jpg', category: 'Sporting Goods', size: [0.8, 0.8, 0.8], hint: 'basketball' }, [aisleXStart + 25, shelfY.mid, backAisleZFront], 40, 'x');
stockShelf({ name: 'Wilson Football', price: 19.99, description: 'Official size NFL football.', image: 'https://m.media-amazon.com/images/I/71zW5vX+5eL._AC_UF894,1000_QL80_.jpg', category: 'Sporting Goods', size: [0.5, 0.5, 0.8], hint: 'american football' }, [aisleXStart + 25, shelfY.low, backAisleZFront], 40, 'x');
stockShelf({ name: 'Ozark Trail Tent', price: 49.99, description: '4-person dome tent.', image: 'https://m.media-amazon.com/images/I/41kblBniEIL._UF894,1000_QL80_.jpg', category: 'Outdoors', size: [1, 1, 1], hint: 'camping tent package' }, [aisleXStart + 40, shelfY.top, backAisleZBack], 16, 'x');
stockShelf({ name: 'Coleman Cooler', price: 24.98, description: '48-Quart Performance 3-Day Cooler.', image: 'https://m.media-amazon.com/images/I/81Aj3l4V-GL._UF894,1000_QL80_.jpg', category: 'Outdoors', size: [1.5, 1.2, 1.2], hint: 'beverage cooler' }, [aisleXStart + 40, shelfY.bottom, backAisleZBack], 16, 'x');
stockShelf({ name: 'Nintendo Switch', price: 299.00, description: 'Nintendo Switch with Neon Blue and Neon Red Joy-Con.', image: 'https://m.media-amazon.com/images/I/41V5KQ500IL._UF894,1000_QL80_.jpg', category: 'Electronics', size: [1, 0.6, 0.4], hint: 'console box' }, [aisleXStart + 15, shelfY.high, backAisleZBack], 30, 'x');
