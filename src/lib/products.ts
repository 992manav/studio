...
stockShelf({ name: 'Quaker Oats', price: 3.88, description: 'Old fashioned rolled oats.', image: 'https://i5.walmartimages.com/seo/Quaker-Old-Fashioned-Rolled-Oats-42-oz_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Groceries', size: [0.6, 0.8, 0.6], hint: 'oats container' }, [aisle1XLeft, shelfY.top, aisleZStart + 8], 15, 'z');
...
stockShelf({ name: 'Coca-Cola 12-Pack', price: 5.98, description: 'A 12-pack of classic Coca-Cola.', image: 'https://i5.walmartimages.com/seo/Coca-Cola-Soda-12-Pack-12-fl-oz-Cans_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Groceries', size: sodaCaseSize, hint: 'coke case' }, [aisle2XRight, shelfY.bottom, aisleZStart], 12, 'z');
stockShelf({ name: 'Coca-Cola 12-Pack', price: 5.98, description: 'A 12-pack of classic Coca-Cola.', image: 'https://i5.walmartimages.com/seo/Coca-Cola-Soda-12-Pack-12-fl-oz-Cans_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Groceries', size: sodaCaseSize, hint: 'coke case' }, [aisle2XRight, shelfY.low, aisleZStart], 12, 'z');
stockShelf({ name: 'Pepsi 12-Pack', price: 5.98, description: 'A 12-pack of classic Pepsi cola.', image: 'https://i5.walmartimages.com/seo/Pepsi-Soda-12-Pack-12-fl-oz-Cans_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Groceries', size: sodaCaseSize, hint: 'pepsi case' }, [aisle2XRight, shelfY.bottom, aisleZStart + 12], 12, 'z');
stockShelf({ name: 'Pepsi 12-Pack', price: 5.98, description: 'A 12-pack of classic Pepsi cola.', image: 'https://i5.walmartimages.com/seo/Pepsi-Soda-12-Pack-12-fl-oz-Cans_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Groceries', size: sodaCaseSize, hint: 'pepsi case' }, [aisle2XRight, shelfY.low, aisleZStart + 12], 12, 'z');
stockShelf({ name: 'Dr Pepper 12-Pack', price: 5.98, description: 'A 12-pack of Dr Pepper soda.', image: 'https://i5.walmartimages.com/seo/Dr-Pepper-Soda-12-Pack-12-fl-oz-Cans_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Groceries', size: sodaCaseSize, hint: 'dr pepper case' }, [aisle2XLeft, shelfY.bottom, aisleZStart], 12, 'z');
stockShelf({ name: 'Dr Pepper 12-Pack', price: 5.98, description: 'A 12-pack of Dr Pepper soda.', image: 'https://i5.walmartimages.com/seo/Dr-Pepper-Soda-12-Pack-12-fl-oz-Cans_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Groceries', size: sodaCaseSize, hint: 'dr pepper case' }, [aisle2XLeft, shelfY.low, aisleZStart], 12, 'z');
stockShelf({ name: 'Mtn Dew 12-Pack', price: 5.98, description: 'A 12-pack of Mtn Dew soda.', image: 'https://i5.walmartimages.com/seo/Mountain-Dew-Soda-12-Pack-12-fl-oz-Cans_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Groceries', size: sodaCaseSize, hint: 'mountain dew case' }, [aisle2XLeft, shelfY.bottom, aisleZStart + 12], 12, 'z');
...
stockShelf({ name: 'Mainstays Bath Towel', price: 4.97, description: 'Soft and absorbent 100% cotton bath towel.', image: 'https://i5.walmartimages.com/seo/Mainstays-Bath-Towel-Blue-27-x-52-in_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Home Goods', size: [1, 0.2, 0.8], hint: 'folded towel' }, [aisle3XRight, shelfY.low, aisleZStart], 20, 'z');
stockShelf({ name: 'T-fal Cookware Set', price: 69.99, description: '18-piece nonstick cookware set.', image: 'https://i5.walmartimages.com/seo/T-fal-Initiatives-Nonstick-Cookware-Set-18-Piece-Black_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Home Goods', size: [1.5, 1.2, 1.5], hint: 'cookware set box' }, [aisle3XRight, shelfY.top, aisleZStart], 6, 'z');
stockShelf({ name: 'George Foreman Grill', price: 29.99, description: 'Classic plate grill for 2 servings.', image: 'https://i5.walmartimages.com/seo/George-Foreman-2-Serving-Classic-Plate-Grill-and-Panini-Press-Black-GR10B_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Home Goods', size: [1, 0.8, 1], hint: 'grill box' }, [aisle3XRight, shelfY.high, aisleZStart], 12, 'z');
stockShelf({ name: 'Oster Blender', price: 24.96, description: 'A powerful 6-speed kitchen blender.', image: 'https://i5.walmartimages.com/seo/Oster-6-Speed-Blender-Black-006878_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Home Goods', size: [0.6, 0.8, 0.6], hint: 'blender box' }, [aisle3XRight, shelfY.mid, aisleZStart], 18, 'z');


// --- AISLE 4: Pharmacy, Personal Care, Apparel (x = 16) ---
const aisle4XLeft = 16.75;
const aisle4XRight = 15.25;
stockShelf({ name: 'Equate Ibuprofen', price: 8.98, description: 'Pain reliever/fever reducer. 200mg tablets.', image: 'https://i5.walmartimages.com/seo/Equate-Ibuprofen-Tablets-200mg-500-Count_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Pharmacy', size: [0.3, 0.5, 0.3], hint: 'medicine bottle' }, [aisle4XLeft, shelfY.low, aisleZStart], 40, 'z');
stockShelf({ name: 'Equate Allergy Relief', price: 12.48, description: '24-hour non-drowsy allergy relief tablets.', image: 'https://i5.walmartimages.com/seo/Equate-Allergy-Relief-Tablets-10mg-30-Count_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Pharmacy', size: [0.3, 0.5, 0.3], hint: 'medicine box' }, [aisle4XLeft, shelfY.low, aisleZStart + 15], 40, 'z');
stockShelf({ name: 'Neutrogena Face Wash', price: 8.49, description: 'Hydro Boost hydrating facial cleansing gel.', image: 'https://i5.walmartimages.com/seo/Neutrogena-Hydro-Boost-Hydrating-Facial-Cleansing-Gel-6-oz_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Personal Care', size: [0.3, 0.8, 0.3], hint: 'face cleanser' }, [aisle4XRight, shelfY.mid, aisleZStart], 30, 'z');
stockShelf({ name: 'CeraVe Moisturizer', price: 14.99, description: 'Moisturizing cream for face and body.', image: 'https://i5.walmartimages.com/seo/CeraVe-Moisturizing-Cream-for-Normal-to-Dry-Skin-16-oz_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Personal Care', size: [0.6, 0.5, 0.6], hint: 'lotion jar' }, [aisle4XRight, shelfY.mid, aisleZStart + 12], 20, 'z');
stockShelf({ name: 'Colgate Toothpaste', price: 3.49, description: 'Cavity protection fluoride toothpaste.', image: 'https://i5.walmartimages.com/seo/Colgate-Cavity-Protection-Fluoride-Toothpaste-6-oz_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Personal Care', size: [0.8, 0.2, 0.15], hint: 'toothpaste box' }, [aisle4XRight, shelfY.low, aisleZStart], 40, 'z');
stockShelf({ name: 'Banana Boat Sunscreen', price: 7.97, description: 'SPF 50 broad spectrum sport sunscreen lotion.', image: 'https://i5.walmartimages.com/seo/Banana-Boat-Sport-Ultra-SPF-50-Sunscreen-Lotion-8-oz_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Personal Care', size: [0.3, 0.8, 0.3], hint: 'sunscreen bottle' }, [aisle4XRight, shelfY.low, aisleZStart + 15], 30, 'z');
stockShelf({ name: 'Hanes T-Shirt', price: 6.0, description: 'Comfortable 100% cotton crewneck t-shirt.', image: 'https://i5.walmartimages.com/seo/Hanes-Men-s-ComfortSoft-Short-Sleeve-T-Shirt-White-XL_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Apparel', size: [0.8, 0.1, 1], hint: 'folded shirt' }, [aisle4XLeft, shelfY.mid, aisleZStart], 20, 'z');
stockShelf({ name: 'Wrangler Mens Jeans', price: 19.98, description: 'Regular fit straight leg jeans for men.', image: 'https://i5.walmartimages.com/seo/Wrangler-Men-s-Regular-Fit-Jeans-Medium-Wash-34x32_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Apparel', size: [0.8, 0.1, 1], hint: 'folded jeans' }, [aisle4XLeft, shelfY.high, aisleZStart], 20, 'z');


// --- Back Aisle: Electronics, Toys, Sporting Goods (z = -22) ---
const backAisleZBack = -22.75;
const backAisleZFront = -21.25;
stockShelf({ name: 'onn. 50" TV', price: 198.0, description: '50" Class 4K UHD LED Roku Smart TV.', image: 'https://i5.walmartimages.com/seo/onn-50-Class-4K-UHD-LED-Roku-Smart-TV-HDR-100012585_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Electronics', size: [4.5, 2.5, 0.2], hint: 'television box' }, [aisleXStart, shelfY.mid, backAisleZBack], 8, 'x');
...
stockShelf({ name: 'onn. Bluetooth Speaker', price: 20.00, description: 'Portable bluetooth speaker.', image: 'https://i5.walmartimages.com/seo/onn-Portable-Bluetooth-Speaker-Black-100008734_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Electronics', size: [0.8, 0.5, 0.4], hint: 'speaker box' }, [aisleXStart + 22, shelfY.low, backAisleZBack], 20, 'x');
...
stockShelf({ name: 'Barbie Dreamhouse', price: 179.00, description: 'The ultimate dollhouse with 3 stories.', image: 'https://i5.walmartimages.com/seo/Barbie-Dreamhouse-Dollhouse-with-75-Accessories_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Toys', size: [2.5, 2.5, 1], hint: 'dollhouse box' }, [aisleXStart + 20, shelfY.top, backAisleZFront], 4, 'x');
stockShelf({ name: 'Nerf Elite 2.0 Blaster', price: 14.97, description: 'Includes 16 Nerf Elite darts.', image: 'https://i5.walmartimages.com/seo/Nerf-Elite-2-0-Commander-RD-6-Blaster-16-Darts_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Toys', size: [1.5, 0.8, 0.4], hint: 'toy gun box' }, [aisleXStart, shelfY.mid, backAisleZFront], 12, 'x');
stockShelf({ name: 'Spalding Basketball', price: 15.88, description: 'Official size street basketball.', image: 'https://i5.walmartimages.com/seo/Spalding-NBA-Street-Basketball-Official-Size-7-29-5-Inch_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Sporting Goods', size: [0.8, 0.8, 0.8], hint: 'basketball' }, [aisleXStart + 20, shelfY.mid, backAisleZFront], 15, 'x');
stockShelf({ name: 'Wilson Football', price: 19.99, description: 'Official size NFL football.', image: 'https://i5.walmartimages.com/seo/Wilson-NFL-Official-Size-Football_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Sporting Goods', size: [0.5, 0.5, 0.8], hint: 'american football' }, [aisleXStart + 20, shelfY.low, backAisleZFront], 15, 'x');
stockShelf({ name: 'Ozark Trail Tent', price: 49.99, description: '4-person dome tent.', image: 'https://i5.walmartimages.com/seo/Ozark-Trail-4-Person-Dome-Tent_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Outdoors', size: [1, 1, 1], hint: 'camping tent package' }, [aisleXStart + 30, shelfY.top, backAisleZBack], 5, 'x');
stockShelf({ name: 'Coleman Cooler', price: 24.98, description: '48-Quart Performance 3-Day Cooler.', image: 'https://i5.walmartimages.com/seo/Coleman-Performance-48-Quart-Cooler-Blue_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg', category: 'Outdoors', size: [1.5, 1.2, 1.2], hint: 'beverage cooler' }, [aisleXStart + 30, shelfY.bottom, backAisleZBack], 5, 'x');
  ...
  for (let j = 0; j < 4; j++) { // width
    for (let k = 0; k < 3; k++) { // depth
      products.push({
        ...
        image: 'https://i5.walmartimages.com/seo/Pepsi-Soda-12-Pack-12-fl-oz-Cans_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg',
        category: 'Groceries',
        position: [
...
for (let i = 0; i < 3; i++) { // height
  for (let j = 0; j < 3; j++) { // width
    for (let k = 0; k < 2; k++) { // depth
        ...
        image: 'https://i5.walmartimages.com/seo/Mountain-Dew-Soda-12-Pack-12-fl-oz-Cans_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e4d2e4f9e3b3d.jpeg',
        category: 'Groceries',
        position: [
