...
stockShelf({ name: 'Tide Laundry Detergent', price: 12.99, description: 'Original scent liquid laundry detergent.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTK-WADZvYD2Z0i9CQJ8PeAWmxdAGdA6--w1g&s', category: 'Home Goods', size: [0.8, 1.2, 0.6], hint: 'detergent bottle' }, [aisle3XLeft, shelfY.bottom, aisleZStart + 20], 20, 'z');
...
stockShelf({ name: 'onn. 50" TV', price: 198.0, description: '50" Class 4K UHD LED Roku Smart TV.', image: 'https://i5.walmartimages.com/seo/onn-50-Class-4K-UHD-LED-Roku-Smart-TV-HDR-100012585_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e-4d2e4f9e3b3d.jpeg', category: 'Electronics', size: [4.5, 2.5, 0.2], hint: 'television box' }, [aisleXStart, shelfY.low, backAisleZBack], 8, 'x');
stockShelf({ name: 'PlayStation 5', price: 499.99, description: 'The Sony PlayStation 5 console.', image: 'https://m.media-amazon.com/images/I/619BkvKW35L._AC_SL1500_.jpg', category: 'Electronics', size: [1.2, 1.4, 0.6], hint: 'console box' }, [aisleXStart, shelfY.mid, backAisleZBack], 10, 'x');
...
stockShelf({ name: 'LEGO Classic Bricks', price: 20.00, description: 'A box of 484 classic LEGO bricks.', image: 'https://target.scene7.com/is/image/Target/GUEST_4c7e3c7f-9e3b-4f8d-9e4d-2e4f9e3b3d4f?wid=488&hei=488&fmt=pjpeg', category: 'Toys', size: [1.2, 0.8, 0.5], hint: 'lego box' }, [aisleXStart, shelfY.bottom, backAisleZFront], 18, 'x');
stockShelf({ name: 'Barbie Dreamhouse', price: 179.00, description: 'The ultimate dollhouse with 3 stories.', image: 'https://i5.walmartimages.com/seo/Barbie-Dreamhouse-Dollhouse-with-75-Accessories_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e-4d2e4f9e3b3d.jpeg', category: 'Toys', size: [2.5, 2.5, 1], hint: 'dollhouse box' }, [aisleXStart + 25, shelfY.high, backAisleZFront], 5, 'x');
stockShelf({ name: 'Nerf Elite 2.0 Blaster', price: 14.97, description: 'Includes 16 Nerf Elite darts.', image: 'https://i5.walmartimages.com/seo/Nerf-Elite-2-0-Commander-RD-6-Blaster-16-Darts_1e4d2e4f-9e3b-3d4f-8d9e-4d2e4f9e3b3d.1e4d2e4f9e3b3d4f8d9e-4d2e4f9e3b3d.jpeg', category: 'Toys', size: [1.5, 0.8, 0.4], hint: 'toy gun box' }, [aisleXStart, shelfY.low, backAisleZFront], 15, 'x');
stockShelf({ name: 'Spalding Basketball', price: 15.88, description: 'Official size street basketball.', image: 'https://m.media-amazon.com/images/I/91A90PxvHHL.jpg', category: 'Sporting Goods', size: [0.8, 0.8, 0.8], hint: 'basketball' }, [aisleXStart + 25, shelfY.low, backAisleZFront], 20, 'x');
stockShelf({ name: 'Wilson Football', price: 19.99, description: 'Official size NFL football.', image: 'https://m.media-amazon.com/images/I/71zW5vX+5eL._AC_UF894,1000_QL80_.jpg', category: 'Sporting Goods', size: [0.5, 0.5, 0.8], hint: 'american football' }, [aisleXStart + 25, shelfY.bottom, backAisleZFront], 20, 'x');
stockShelf({ name: 'Ozark Trail Tent', price: 49.99, description: '4-person dome tent.', image: 'https://m.media-amazon.com/images/I/41kblBniEIL._UF894,1000_QL80_.jpg', category: 'Outdoors', size: [1, 1, 1], hint: 'camping tent package' }, [aisleXStart + 35, shelfY.mid, backAisleZBack], 8, 'x');
stockShelf({ name: 'Coleman Cooler', price: 24.98, description: '48-Quart Performance 3-Day Cooler.', image: 'https://m.media-amazon.com/images/I/81Aj3l4V-GL._UF894,1000_QL80_.jpg', category: 'Outdoors', size: [1.5, 1.2, 1.2], hint: 'beverage cooler' }, [aisleXStart + 35, shelfY.bottom, backAisleZBack], 8, 'x');
...
addProducePile({
    ...
    size: [0.3, 0.4, 0.3],
    hint: 'green pepper'
}, [-12, binSurfaceY, produceBinZ], [binPileSize[0], binPileSize[1]], 20);
...
addProducePile({
    ...
    size: [0.2, 0.1, 0.6],
    hint: 'banana'
}, [-8, binSurfaceY, produceBinZ], [binPileSize[0], binPileSize[1]], 30);
...
addProducePile({
    ...
    size: [0.3, 0.3, 0.3],
    hint: 'red apple'
}, [0, binSurfaceY, produceBinZ], [binPileSize[0], binPileSize[1]], 25);
...
addProducePile({
    ...
    size: [0.3, 0.3, 0.3],
    hint: 'orange fruit'
}, [4, binSurfaceY, produceBinZ], [binPileSize[0], binPileSize[1]], 25);
...
addProducePile({
    ...
    size: [0.6, 1.0, 0.6],
    hint: 'pineapple'
}, [12, binSurfaceY, produceBinZ], [binPileSize[0], binPileSize[1]], 8);
...
addProducePile({
    ...
    size: [0.6, 0.5, 0.6],
    hint: 'lettuce head'
}, [16, binSurfaceY, produceBinZ], [binPileSize[0], binPileSize[1]], 10);
